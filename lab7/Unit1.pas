...
begin
    ...
    Delay(n*1000);
      Memo1.Lines.Clear();
      Memo1.Lines.Add('5. Ожидание DSR');
  ...
  repeat
      ...
      n:=strtoint(Form1.Delayindic.Text);
      Memo1.Lines.Clear();
      Memo1.Lines.Add('6. Вывод байта из ОЗУ в AL');
      Memo1.Lines.Add('7. Инкремент SI');
      Memo1.Lines.Add('8. Вывод байта из AL в порт передатчика');

      Form1.Label87.Font.Color:=clGreen;
      Form1.Shape64.Brush.Color:=clGreen;
      Delay(n*600);
      Memo1.Lines.Clear();
      Memo1.Lines.Add('9.Проверка Out0=1');
    ...
    begin
    Memo1.Lines.Clear();
    Memo1.Lines.Add('10. Передача завершена');
    Memo1.Lines.Add('11. Перезапуск Сч0');
    Memo1.Lines.Add('12. Ожидание DSR');
    ...
    Delay(n*500);
    Memo1.Lines.Clear();
    Memo1.Lines.Add('13. Ожидание RxRDY');
    ...
    Delay(n*500);
    Memo1.Lines.Clear();
    Memo1.Lines.Add('14. Ввод байта в AL из объекта');
    Memo1.Lines.Add('15. Ввод байта из AL в ОЗУ');
    Memo1.Lines.Add('16. Инкремент DI');
    ...
    Delay(n*500);
    Memo1.Lines.Clear();
    Memo1.Lines.Add('14. Проверка Out0=1');
    ...
    Delay(n*500);
     Memo1.Lines.Clear();
    Memo1.Lines.Add('15. Передача завершена');
           Form1.Label86.Font.Color:=clGreen;
      Form1.Shape57.Brush.Color:=clGreen;
      Form1.Shape39.Pen.Color:=clGreen;
      Form1.Shape41.Brush.Color:=clGreen;
